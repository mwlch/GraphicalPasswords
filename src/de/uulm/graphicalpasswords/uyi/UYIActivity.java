...
public class UYIActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_settings:
			Intent intent = new Intent(this,
					de.uulm.graphicalpasswords.uyi.UYISettingsActivity.class);
	...
	public void startCreatePassword(View view) {
		Intent intent = new Intent(this,
				de.uulm.graphicalpasswords.uyi.UYICreatePasswordActivity.class);
		startActivity(intent);
	}

	public void startEnterPassword(View view) {
		Intent intent = new Intent(this,
				de.uulm.graphicalpasswords.uyi.UYILoginActivity.class);
		startActivity(intent);
	}
